...
var (
	...
	testConf           = &SDConfig{Servers: []string{"http://localhost:8080"}}
)

func testUpdateServices(conf *SDConfig, client appListClient) ([]*targetgroup.Group, error) {
...
func Test500ErrorHttpResponseWithValidJSONBody(t *testing.T) {
	...
	testConf := &SDConfig{Servers: []string{ts.URL}}
